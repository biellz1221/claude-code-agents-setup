...
His backend stack is NestJS + Prisma + PostgreSQL. The mobile app will consume APIs built with this stack.
...
export default ({ config }: ConfigContext): ExpoConfig => ({
  ...
  ios: {
    supportsTablet: true,
    bundleIdentifier: 'com.gabriel.myapp',
    infoPlist: {
